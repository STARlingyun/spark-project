...
import com.google.sparkproject.dao.*;
import com.google.sparkproject.domian.SessionAggrStat;
...
import com.google.sparkproject.test.MockData;
import com.google.sparkproject.util.*;
...
public class UserVisitSessionAnalyzeSpark {
        ...
        JavaPairRDD<String, String> filteredSessionid2AggrInfoRDD = sessionid2AggrInfoRDD.filter(
                ...
                new Function<Tuple2<String,String>, Boolean>() {
                    ...
                    public Boolean call(Tuple2<String, String> tuple) throws Exception {
                        ...
                        long visitLength = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                                aggrInfo, "\\|", Constants.FIELD_VISIT_LENGTH)));
                        long stepLength = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
    ...
    private static void calculateAndPersistAggrStat(String value, long taskid) {
        // 从Accumulator统计串中获取值
        long session_count = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.SESSION_COUNT)));

        long visit_length_1s_3s = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.TIME_PERIOD_1s_3s)));
        long visit_length_4s_6s = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.TIME_PERIOD_4s_6s)));
        long visit_length_7s_9s = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.TIME_PERIOD_7s_9s)));
        long visit_length_10s_30s = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.TIME_PERIOD_10s_30s)));
        long visit_length_30s_60s = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.TIME_PERIOD_30s_60s)));
        long visit_length_1m_3m = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.TIME_PERIOD_1m_3m)));
        long visit_length_3m_10m = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.TIME_PERIOD_3m_10m)));
        long visit_length_10m_30m = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.TIME_PERIOD_10m_30m)));
        long visit_length_30m = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.TIME_PERIOD_30m)));

        long step_length_1_3 = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.STEP_PERIOD_1_3)));
        long step_length_4_6 = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.STEP_PERIOD_4_6)));
        long step_length_7_9 = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.STEP_PERIOD_7_9)));
        long step_length_10_30 = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.STEP_PERIOD_10_30)));
        long step_length_30_60 = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
                value, "\\|", Constants.STEP_PERIOD_30_60)));
        long step_length_60 = Long.valueOf(Objects.requireNonNull(StringUtils.getFieldFromConcatString(
